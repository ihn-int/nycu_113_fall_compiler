...
class CodeGenerator final : public AstNodeVisitor {
  private:
    ...
    // Other fields
    int stack_pointer;  // stack top
    int frame_pointer;  // stack bottom
    int access_offset;  // the available varaible offset
    int label_count;    // record the number of label
    RefSide ref_side;
    bool table_found;
